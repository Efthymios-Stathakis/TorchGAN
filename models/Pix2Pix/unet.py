...
class UNet(nn.Module):
    ...
    """
    def __init__(self, input_dim, label_dim, hidden_size=32):
        """
        ...
        self.contracting_block2 = ContractingBlock(hidden_size * 1,  hidden_size * 2, use_dropout=True)
        self.contracting_block3 = ContractingBlock(hidden_size * 2,  hidden_size * 4, use_dropout=True)
        self.contracting_block4 = ContractingBlock(hidden_size * 4,  hidden_size * 8, use_dropout=True)
        self.contracting_block5 = ContractingBlock(hidden_size * 8,  hidden_size * 16)
        self.contracting_block6 = ContractingBlock(hidden_size * 16, hidden_size * 32)
        
        self.expanding_block5 = ExpandingBlock(hidden_size * 32, hidden_size * 16)
        self.expanding_block4 = ExpandingBlock(hidden_size * 16, hidden_size * 8)
        self.expanding_block3 = ExpandingBlock(hidden_size * 8, hidden_size * 4)
        self.expanding_block2 = ExpandingBlock(hidden_size * 4, hidden_size * 2)
        self.expanding_block1 = ExpandingBlock(hidden_size * 2, hidden_size * 1)
        
        self.upsampling_block5 = UpsamplingBlock(hidden_size * 32, hidden_size * 16)
        self.upsampling_block4 = UpsamplingBlock(hidden_size * 16, hidden_size * 8)
        self.upsampling_block3 = UpsamplingBlock(hidden_size * 8,  hidden_size * 4)
        self.upsampling_block2 = UpsamplingBlock(hidden_size * 4,  hidden_size * 2)
        self.upsampling_block1 = UpsamplingBlock(hidden_size * 2,  hidden_size * 1)
    ...
    def forward(self, x):
        ...
        eb4  = self.expanding_block4(eb5_, cb4)
        eb4_ = self.upsampling_block3(eb4)
        eb3  = self.expanding_block3(eb4_, cb3)
        eb3_ = self.upsampling_block2(eb3)
        eb2  = self.expanding_block2(eb3_, cb2)
        eb2_ = self.upsampling_block1(eb2)
        eb1  = self.output(eb2_)
        
        return self.sigmoid(eb1)
